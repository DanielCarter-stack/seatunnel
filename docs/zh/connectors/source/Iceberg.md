...
| 参数名                     | 类型    | 必须 | 默认值              | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|--------------------------|---------|------|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| catalog_name             | string  | 否   | default               | 用户指定的目录名称。未显式配置时默认 `default`。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| namespace                | string  | 否   | default               | 后端目录中的 iceberg 数据库名称。默认 `default`。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| table                    | string  | 与 `table_list` 互斥 | -        | 后端目录中的 Iceberg 表名称。`table` 和 `table_list` 必须二选一配置，不能同时配置。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| table_list               | list    | 与 `table` 互斥 | -                    | 后端目录中的 Iceberg 表列表。`table` 和 `table_list` 必须二选一配置，不能同时配置。每一项都支持 `namespace`、`table`、`query`、`startSnapshotId`、`startSnapshotTimestamp`、`endSnapshotId`、`useSnapshotId`、`useSnapshotTimestamp`、`streamScanStrategy`。                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| query                    | String  | 否   | -                    | 用于过滤或投影 Iceberg 数据的 select DML。查询中可以使用任意表别名（实际表名在运行时绑定），例如 `select * from t where f1 > 100`、`select f1 from t where f2 like 'tom%'`。当前对 LIKE 语法的支持有限：LIKE 模式不应以 `%` 开头。                                                                                                                                                                                                                                                       |
